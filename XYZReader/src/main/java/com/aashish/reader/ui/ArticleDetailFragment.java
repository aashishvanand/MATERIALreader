...
import com.aashish.reader.ui.ImageLoaderHelper;
import com.aashish.reader.ui.ObservableScrollView;
import com.aashish.reader.ui.ArticleListActivity;
        ...
        rootView.findViewById(R.id.share_fab).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(Intent.createChooser(ShareCompat.IntentBuilder.from(getActivity())
                        .setType("text/plain")
                        .setText("Hey check out! "+"https://play.google.com/store/apps/details?id="+appPackageName)
