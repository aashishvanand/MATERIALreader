...
import com.aashish.chennaichanceyillai.remote.RemoteEndpointUtil;
...
public class UpdaterService extends IntentService {
    ...
    public static final String BROADCAST_ACTION_STATE_CHANGE
            = "com.aashish.chennaichanceyillai.intent.action.STATE_CHANGE";
    public static final String EXTRA_REFRESHING
            = "com.aashish.chennaichanceyillai.intent.extra.REFRESHING";
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        try {
            ...
            for (int i = 0; i < array.length(); i++) {
                ...
                values.put(ItemsContract.Items.PLACE, object.getString("place"));
                values.put(ItemsContract.Items.TITLE, object.getString("title"));
                values.put(ItemsContract.Items.BODY, object.getString("body"));
                values.put(ItemsContract.Items.THUMB_URL, object.getString("thumb"));
                values.put(ItemsContract.Items.PHOTO_URL, object.getString("photo"));
                values.put(ItemsContract.Items.ASPECT_RATIO, object.getString("aspect_ratio"));
                values.put(ItemsContract.Items.URL, object.getString("url"));
